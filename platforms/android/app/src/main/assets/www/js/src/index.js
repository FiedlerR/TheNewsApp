...
import $ from 'jquery';
import settingsModule, { saveNewsSettings } from './modules/settingsModule.js';
...
function appReady() {
    ...
    country = settingsModule.getCountry();
    categories = settingsModule.getCategories();
  ...
  // $("#newsOverviewSettingsCountry").val();
    //setAvailableChips();
