...
function appReady() {
    ...
    uiModule.activateTheme(settingsModule.getTheme());
    uiModule.setNewsCountry(settingsModule.getCountry());
    newsFeedModule.buildCategoryUI(settingsModule.getCountry(),settingsModule.getCategories(),uiModule);
    newsFeedModule.loadHeadLines(settingsModule.getCountry());
    uiModule.setSelectedCategoryChips(settingsModule.getCategories());
...
function saveUiSettingsEvent () {
    ...
    uiModule.activateTheme(selectedTheme);
